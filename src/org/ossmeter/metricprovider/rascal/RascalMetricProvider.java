...
public abstract class RascalMetricProvider implements ITransientMetricProvider<RascalMetrics> {
  ...
  private static Evaluator initEvaluator() {
    ...
    IURIInputStreamResolver metrics = new ClassResourceInputOutput(eval.getResolverRegistry(), "metrics", RascalMetricProvider.class, "");
  ...
  public RascalMetricProvider(URI metric) {
    this.metric = metric;
  ...
  @Override
  public void measure(Project project, ProjectDelta projectDelta, RascalMetrics db) {
    try {
